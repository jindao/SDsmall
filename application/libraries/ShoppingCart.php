...
class ShoppingCart
{
    ...
    public function __construct()
    {
        ...
        $this->CI->load->model(array('Public_model',));
    }
    ...
    public function getCartItems()
    {
        ...
        } elseif (!isset($_SESSION['shopping_cart']) || !is_array($_SESSION['shopping_cart']) || $_SESSION['shopping_cart'] == NULL) {
            return 0;
        }
        ...
        foreach ($result['array'] as &$article) {
            ...
            $article['sum_price'] = $article['price'] * 1 ; // $count_articles[$article['id']];  // with  not product as downloads no need count...
